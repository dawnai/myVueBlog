    ...
    <div>
            ...
            <el-row>
                <el-col :span="12">
                    ...
                    <p class="myWebIntrooduce" style="margin-top: 20px;"> <a href="https://www.bilibili.com"
                            style="text-decoration: none;color:#002FA7 ;">去看看我的文章 <svg t="1692842691541" class="icon"
                                viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6299"
                                width="25" height="25">
                                <path
        ...
        <div style="margin:30px 100px; border-right:1px solid #bcbbbb ;">
            <el-row type="flex" align="middle">
                ...
                <el-col :span="12">
                    <div style="background-color: white; padding: 30px 0px 30px 40px;margin-left: -10%;">
            ...
            <el-row type="flex" justify="center" style="margin-top:30px" :gutter="30">
                ...
                <el-col :span="7">
                    ...
                    <a href="https://space.bilibili.com/375065148?spm_id_from=333.337.0.0"
                        style="color:black; text-decoration:none">
                        <h3>B站up:虞兮西西 <svg t="1692949855247" class="icon" viewBox="0 0 1024 1024" version="1.1"
