            ...
            <el-row style="display: flex">
              ...
              <el-col :span="2" class="headButton">
                ...
                >
                  ...
                  ></path>
                  <path
                    d="M426.75 725.23m-42.66 0a42.66 42.66 0 1 0 85.32 0 42.66 42.66 0 1 0-85.32 0Z"
                    fill="#1A1A1A"
                    p-id="5867"
                  ></path>
                  <path
                    d="M554.73 725.23m-42.66 0a42.66 42.66 0 1 0 85.32 0 42.66 42.66 0 1 0-85.32 0Z"
                    fill="#1A1A1A"
                    p-id="5868"
                  ></path>
                  <path
                    d="M682.72 725.23m-42.66 0a42.66 42.66 0 1 0 85.32 0 42.66 42.66 0 1 0-85.32 0Z"
                    fill="#1A1A1A"
                    p-id="5869"
                  ></path>
                  <path
      ...
      <el-main>
        <div class="myIntroduce">
          <el-row style="margin-top: 50px">
            ...
            <el-col :span="10">
              <el-card>
                <h1 style="font-size: 100px;">Wellcom to</h1>
                <h1 style="font-size: 100px;">DAWN's Home</h1>
                <h2></h2>    
            </el-card>
            </el-col>
          </el-row>
...
.myLogoText {
  ...
  -webkit-background-clip: text; /* 适用于WebKit内核的浏览器（Chrome、Safari等） */
  color: transparent; /* 让文字透明 */
}
/* .myIntroduce{
    height: 1000px;
